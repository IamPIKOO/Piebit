...
<style>
    ...
    * {
    ...
    .inputPart1 input::placeholder {
        color: var(--input-text-color);
    }

    .inputPart1 input:focus {
        padding-left: 50px;
    ...
    .inputPart2 input::placeholder {
        color: var(--input-text-color);
    }

    .inputPart2 input:focus {
        padding-left: 50px;
        border: 1px solid var(--secondary-color-blue);
    }
